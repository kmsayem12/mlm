                                        ...
                                        <table class="table table-hover m-b-0 without-header">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-inline-block align-middle">
                                                            <img src="{{ asset('backend/assets/images/avatar-4.jpg') }}" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-inline-block align-middle">
                                                            <img src="{{ asset('backend/assets/images/avatar-2.jpg') }}" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                            <div class="d-inline-block">
